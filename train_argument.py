...
def parser():
    ...
    parser.add_argument('--model', choices=['ResNet18', 'VGG16', 'WideResNet', 'ResNet20', 'ResNet34', 'VGG19'], default='VGG16',
    ...
    parser.add_argument('--milestones', type=int, default=[60], nargs="*")
